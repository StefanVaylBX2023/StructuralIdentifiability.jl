...
function integral_tester(ode::ODE{P}) where {P <: MPolyElem}
    ...
    map_p_res = Dict{fmpq_mpoly, fmpq}(
        p => (map_p_str[var_to_str(p)]) for
        p in res_ode.parameters if var_to_str(p) ∉ map(var_to_str, collect(keys(cvars)))
    )
    for (x, f) in cvars
...
@testset "test integrals" begin
    cases = [
        ...
        @ODEmodel(
            S'(t) =
                -b * ln(t) * S(t) // (S(t) + L(t) + ln(t) + R(t) + Q(t)) -
                u(t) * S(t) // (S(t) + L(t) + ln(t) + R(t) + Q(t)),
        ...
        @ODEmodel(
            Sh'(t) =
                mh * (Sh(t) + Lh(t) + Ih(t) + Rh(t)) -
                bv * Sh(t) * Iv(t) // (Sh(t) + Lh(t) + Ih(t) + Rh(t)) - mh * Sh(t),
            Lh'(t) =
                bv * Sh(t) * Iv(t) // (Sh(t) + Lh(t) + Ih(t) + Rh(t)) - ah * Lh(t) -
                mh * Lh(t),
            Ih'(t) = ah * Lh(t) - gh * Ih(t) - mh * Ih(t),
            Rh'(t) = gh * Ih(t) - mh * Rh(t),
            Sv'(t) =
                mv * (Sv(t) + Lv(t) + Iv(t)) -
                bh * Sv(t) * Ih(t) // (Sh(t) + Lh(t) + Ih(t) + Rh(t)) - mv * Sv(t),
            Lv'(t) =
                bh * Sv(t) * Ih(t) // (Sh(t) + Lh(t) + Ih(t) + Rh(t)) - av * Lv(t) -
                mv * Lv(t),
            Iv'(t) = av * Lv(t) - mv * Iv(t),
            y1(t) = Ih(t) // (Sh(t) + Lh(t) + Ih(t) + Rh(t))
        ),
        @ODEmodel(x1'(t) = -x1(t) + x2(t), x2'(t) = x1(t), y1(t) = x1(t) - x2(t)),
        @ODEmodel(
            KS00'(t) =
                -a00 * K(t) * S00(t) +
                b00 * KS00(t) +
